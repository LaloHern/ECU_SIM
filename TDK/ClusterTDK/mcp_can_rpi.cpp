...
bool MCP_CAN::setupInterruptGpio()
{
    ...
    return true;
#else
    qDebug("Can't use GPIO on non-ARM processor");
    return false;
#endif
}
...
bool MCP_CAN::setupSpi()
{
    ...
    return true;
#else
    qDebug("Can't use SPI on non-ARM processor");
    return false;
#endif
}
...
INT8U MCP_CAN::mcp2515_init(const INT8U canIDMode, const INT8U canSpeed, const INT8U canClock)
{
  ...
  INT8U res;
    ...
    {
#if DEBUG_MODE
      qDebug("Entering Configuration Mode Failure...\r\n");
#endif
      return res;
    }
#if DEBUG_MODE
    qDebug("Entering Configuration Mode Successful!\r\n");
#endif
    ...
    {
#if DEBUG_MODE
      qDebug("Setting Baudrate Failure...\r\n");
#endif
      return res;
    }
#if DEBUG_MODE
    qDebug("Setting Baudrate Successful!\r\n");
#endif
...
*/
            ...
            default:
#if DEBUG_MODE
            qDebug("`Setting ID Mode Failure...\r\n");
#endif
            return MCP2515_FAIL;
            break;
}
        ...
        {
#if DEBUG_MODE
          qDebug("Returning to Previous Mode Failure...\r\n");
#endif
          return res;
        }
...
INT8U MCP_CAN::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
  ...
  return res;
    ...
    if(res > 0){
#if DEBUG_MODE
    qDebug("Entering Previous Mode Failure...\r\nSetting Mask Failure...\r\n");
#endif
    return res;
  }
#if DEBUG_MODE
    qDebug("Setting Mask Successful!\r\n");
#endif
    return res;
}
...
INT8U MCP_CAN::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
    qDebug("Starting to Set Filter!\r\n");
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0)
    {
#if DEBUG_MODE
      qDebug("Enter Configuration Mode Failure...\r\n");
#endif
      return res;
    }
...
#if DEBUG_MODE
    qDebug("Setting Filter Successfull!\r\n");
#endif
